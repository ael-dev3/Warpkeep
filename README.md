...
| 🚧 In progress | Alpha 0.3.18 is preparing four permanent workers, flexible gathering, automatic settlement, and safe legacy-wagon returns. These remain inactive until the guarded production rollout succeeds. |
...
- **Release:** The [Alpha 0.3.18 release notes](CHANGELOG.md#0318--2026-07-24) describe the prepared rollout and its live-state boundary.
