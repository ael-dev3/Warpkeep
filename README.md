...
| State | Today |
| --- | --- |
| 🚧 Release candidate | Alpha 0.3.19 is undergoing its protected deployment and production smoke test. |
...
- **Release:** The [Alpha 0.3.19 release notes](CHANGELOG.md#0319--2026-07-25) describe map-first worker journeys through the Lowlands.
