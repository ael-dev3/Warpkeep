...
const SEALED_REALMS_SOURCE_AUTHORITY_SOURCE_SHA256 =
  '1bba7e11f5b7d1d7bba584d32f1e30f376fe00b07b7990b2175ffcad3114a09b';
const SEALED_REALMS_SOURCE_AUTHORITY_DECLARATION_SHA256 =
  '098edc6f881d85438bfb15ca9fcadbcb6ee110691fc369f10f8d1d1294ef7005';
...
const GENESIS_001_POLICY_OBSERVATION_SOURCE_SHA256 =
  '148cbeb227b4675a75a6ec067648876b79349b88e8a9c5d9f76ee34c71ab1285';
...
const GENESIS_001_SEALED_LAUNCH_ADOPTION_SOURCE_SHA256 =
  'b478b013893352190b5299ee2630a91c65827ebf7909bdbd91d7c6b73f8b52ee';
...
const SEALED_LAUNCH_PACKAGE_STRUCTURE_SHA256 =
  'e5569652bba79243b550537d72d33e190b9af85727f94ca6e4ecb6cbd0c71558';
const SEALED_LAUNCH_LOCK_STRUCTURE_SHA256 =
  '568723b05559d429fa246da0791a45bfe2ad2fb651d4366b4b81477e9ec932b4';
...
function verifyGenesis002Policy(sources) {
  ...
  for (const [source, expectedSha256] of [
    ...
    [sources.genesis002AuthSource,
      'fe10ba4216187b09aa695aa21fa3348a235f6c7985a1a62fcf003b6884b83f53'],
...
function verifyPtrOwnerAuthority(sources) {
  ...
  for (const [source, expectedSha256] of [
    ...
    [sources.ptrOwnerPolicySource,
      'd9bfaa7bc4edc41b36d762ace0b22bac0765aa8e0efeeb1e363b51a93cf03e43'],
    [sources.ptrAuthSource,
      'b1fe368989def0ec640baf6ab8a92f3e5ad69b304dcb8fe693ce841bfe34ccae'],
...
function parseNativeSealedLaunchBinding(source) {
  ...
  if (schema === 2 || schema === 3 || schema === 4 || schema === 5 || schema === 6) return parseRecoveryBinding(source);
...
export function verifySealedLaunchSources(sources, requestedPhase = 'checked-in') {
  ...
  return Object.freeze({
    ...
    ...(binding.schemaVersion === 4 || binding.schemaVersion === 5 || binding.schemaVersion === 6 ? {} : { ptrPresentationEnabled: binding.ptrPresentationEnabled }),
  });
}
...
export function classifySealedLaunchPagesSources(sources) {
  ...
  return [2, 3, 4, 5, 6].includes(result.schemaVersion) ? 'sealed-g002-recovery' : 'sealed-g002';
}
...
export function verifySealedLaunchPagesBuildEnvironment({
  ...
  if (typeof bindingSource === 'string' && bindingSource.length <= 2 * 1024 * 1024
      && [2, 3, 4, 5, 6].includes(JSON.parse(bindingSource)?.schemaVersion)) {
...
export function classifySealedLaunchPagesDeployLane({
  ...
  if (schema === 2 || schema === 3 || schema === 4 || schema === 5 || schema === 6) {
    ...
    return Object.freeze({ profile: schema === 2 ? 'warpkeep-0.4.0-sealed-launch-v2'
      : schema === 3 ? 'warpkeep-0.4.0-sealed-launch-ptr-update-v3'
        : schema === 4 ? 'warpkeep-0.4.0-sealed-launch-ptr-adoption-v4'
          : schema === 5 ? 'warpkeep-0.4.0-sealed-launch-g002-ptr-adoption-v5' : 'warpkeep-0.4.0-sealed-launch-g001-linux-freeze-v6', candidatePagesSourceCommit,
