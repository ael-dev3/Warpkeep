...
function record(input) {
  ...
  if (value.schemaVersion !== 1 || value.profile !== ACTIVATION_GENERATION_RECEIPT_PROFILE
    ...
    || ![1, 2, 3, 4, 5, 6].includes(value.artifactSchemaVersion)
    || value.artifactProfile !== (value.artifactSchemaVersion === 6
      ? 'warpkeep-0.4.0-sealed-launch-g001-linux-freeze-v6' : value.artifactSchemaVersion === 5
      ? 'warpkeep-0.4.0-sealed-launch-g002-ptr-adoption-v5'
      : value.artifactSchemaVersion === 4
