...
export type ActivationGenerationReceipt = Readonly<{
  ...
  artifactSchemaVersion: 1 | 2 | 3 | 4 | 5;
  artifactProfile: 'warpkeep-0.4.0-sealed-launch-v1' | 'warpkeep-0.4.0-sealed-launch-v2' | 'warpkeep-0.4.0-sealed-launch-ptr-update-v3' | 'warpkeep-0.4.0-sealed-launch-ptr-adoption-v4' | 'warpkeep-0.4.0-sealed-launch-g002-ptr-adoption-v5';
  generatedAt: string;
  outcome: 'generated';
}>;
