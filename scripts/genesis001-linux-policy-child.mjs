...
const POLICY_DIAGNOSTICS_BY_CODE = new Map([
  ['GENESIS_001_POLICY_OBSERVATION_SOURCE_EXECUTION_FAILED', 'g001-policy-authority'],
  ['GENESIS_001_POLICY_OBSERVATION_CREDENTIAL_READ_FAILED', 'g001-policy-credential'],
  ['GENESIS_001_POLICY_OBSERVATION_SESSION_SETUP_FAILED', 'g001-policy-transport'],
  ['GENESIS_001_POLICY_OBSERVATION_REFRESH_FAILED', 'g001-policy-transport'],
  ['GENESIS_001_POLICY_OBSERVATION_INSPECTION_FAILED', 'g001-policy-inspect'],
  ['GENESIS_001_POLICY_OBSERVATION_POLICY_VALIDATION_FAILED', 'g001-policy-state'],
  ['GENESIS_001_POLICY_OBSERVATION_RECEIPT_BUILD_FAILED', 'g001-receipt'],
  ['GENESIS_001_POLICY_OBSERVATION_SESSION_CLEANUP_FAILED', 'g001-policy-cleanup'],
...
const ADMIN_TOKEN_BUDGET_DIAGNOSTICS_BY_CODE = new Map([
  ...
  ['PRODUCTION_ADMIN_TOKEN_LEDGER_INTERRUPTED_SIGINT', 'g001-policy-budget-interrupted'],
  ['PRODUCTION_ADMIN_TOKEN_LEDGER_INTERRUPTED_SIGTERM', 'g001-policy-budget-interrupted'],
