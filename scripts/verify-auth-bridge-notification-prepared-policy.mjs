...
export function verifyAuthBridgeNotificationPreparedStaticPolicy({
  ...
  for (const [exact, count] of [
    ...
    ['values.WARPKEEP_PTR_SPACETIMEDB_DATABASE', 9],
    ['recoveryObserver: true,', 2],
    ['recoveryRpcSecret: values.WARPKEEP_RELEASE_RECOVERY_RPC_SECRET,', 1],
    ['recoveryCensusPepper: values.WARPKEEP_RELEASE_RECOVERY_CENSUS_PEPPER,', 1],
