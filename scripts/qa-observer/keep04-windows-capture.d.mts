...
export function createKeep04NetworkGuard(): { expectNavigation(url: string): void; setTarget(id: string): void; beginOwnedClose(): void; acknowledgeOwnedClose(): void; finishOwnedClose(verified: boolean): void; event(method: string, params: unknown, session: unknown): void; drain(): Promise<void>; assert(): void; assertDocumentReady(): void; snapshot(): unknown };
