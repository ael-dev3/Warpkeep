...
import type { SealedRealmsProductionPtrExistingStateAdoptionEvidence } from './sealed-realms-production-activation-records.mjs';
...
/** Evidence comparison, never generation or deployment authority. V4 requires the retained opaque capability. */
