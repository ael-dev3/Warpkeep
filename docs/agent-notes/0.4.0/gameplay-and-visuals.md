...
Updated 2026-09-10 against current PR #228 branch tip `3eb52ee9` (functional
source checkpoint `53cad795`) and the inspected working files. Earlier source hashes below remain dated evidence
