...
`codex/prepared-keep-bindings-fix` (functional source checkpoint `6e2164f1`). It includes
...
This branch is the active remote check set; no live release, physical-device
