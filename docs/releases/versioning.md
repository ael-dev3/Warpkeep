...
| --- | --- | --- |
| Checked-in product version | Player-facing semantic version in source; may still be a candidate | `ALPHA 0.3.10` (candidate) |
...
The checked-in package identifies the undeployed Alpha 0.3.10 candidate. It
...
bounded Tier-I Wheat Farm Food loop. Alpha 0.3.6 remains the verified public
release until the complete 0.3.10 release matrix, protected-main publication,
separately approved additive module, founder-resource backfill, Gold/forest/Food
setup, exact Pages deployment, and post-deploy build checks pass.
