...
| --- | --- | --- |
| Checked-in product version | Player-facing semantic version in source; may still be a candidate | `ALPHA 0.3.11` (candidate) |
...
The checked-in package identifies the undeployed Alpha 0.3.11 candidate. It
stacks the pending resource authority, additive Genesis 001 generation-three
world definition, bounded Gold Mine wagon loop, shared forest presentation, and
bounded Tier-I Wheat Farm Food and Logging Camp Wood loops. Alpha 0.3.6 remains
the verified public release until the complete 0.3.11 release matrix,
protected-main publication, separately approved additive module,
founder-resource backfill, Gold/forest/Food/Wood setup, exact Pages deployment,
and post-deploy build checks pass. Wood is an additive v8 schema suffix at refs
32–36; its 96-site Logging Camp loop and paired Food/Wood reservation remain
candidate-only until their independent approval and verification gates pass.
