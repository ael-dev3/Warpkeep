...
- “Lowlands Of Hegemony” is now the dedicated authenticated Lowlands score. This menu archive preserves the original reference copy; the authoritative dated source/runtime record is [`../../audio/2026-07-11-lowlands-of-hegemony/`](../../audio/2026-07-11-lowlands-of-hegemony/). The application serves only its cleaned audio-only derivative after realm entry.
