...
The published Windows/GitHub head is `05103e3`
...
Sharp's hosted `libvips 8.18.6` tuple.
...
runtime image verifier with Sharp 0.35.4. Its Verify run and CodeQL result must
