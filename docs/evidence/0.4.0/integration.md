...
Source PR #249 is now protected-merged as `61b8a03d04fcae2db3913d10e2025fa6c3e8529f` on top of M2. Its source checks passed at `d3bfe6f1`; post-merge main Verify `34770379931` remains the current source gate. Documentation PR #248 is the only active review at `0b86653c`, with Verify `34772160132` pending. Read both at terminal state before treating the docs refresh as integrated.
