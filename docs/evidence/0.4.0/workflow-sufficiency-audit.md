...
integration. The recovery CLI correction, complete-family preparation/check,
authenticated generated-family integration, protected-main merge and accepted-
main M1 preparation/check are complete. It is not yet sufficient to ship 0.4:
generated-only M2 promotion, genuine operating authority, live preservation and
player/device acceptance remain open. Overall completion is approximately
**78%** (a 72–83% judgment range), based on milestone coverage
...
- Windows editing and the dedicated Linux runner/preparation path are operational.
  Accepted-main M1 preparation and its independent check succeeded from signed
  `27c2d276`; generated-only M2 and sealed preflight remain the next gates. Reuse
  the attested tools and compatible caches without relabeling earlier generated
  output.
...
- PR #245 was merged into protected main as the GitHub-verified squash commit
  ...
  current eligibility gate and passed every required context. Accepted-main M1
  preparation/check then converged on `release-workspace-83bf0da57a1a622d84742c445f8450a9`;
  generated-only M2 remains the next release operation.
...
- The prepared closure CLI correction now authenticates the exact V2–V5
  ...
  exact identities in the handoff. The accepted-main M1 preparation/check now
  supersedes that earlier development input; retain its exact identities before
...
1. Promote the authenticated M1 family through protected M2 from the exact
   accepted-main source. Record the generated patch and preserve the M1
   transaction, family, closure and scanner identities.
2. Require M2 Verify and a fresh read-only sealed `preflight-inspected` result;
   M1 remains the manifest source ancestor. Do not treat an earlier preflight as
   authority for this source or deploy preparation-only output.
3. Capture fresh G001 and sealed G002 baselines, re-attest the genuine bridge
...
4. Complete actual owner play, lifecycle/isolation, final rendered views and the
...
5. Verify live G001 preservation, sealed G002 denial and the actual owner journey.
