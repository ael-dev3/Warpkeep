...
Alpha 0.3.12 uses backend protocol 3 and authentication contract v2; admission
...
checked-in `PUBLIC_AUTH_ENABLED` remains false, while the recorded Alpha 0.3.12
