...
The command records in this section are historical: they were executed before this report was later relocated outside the closed candidate-evidence namespace. Their report arguments therefore name the then-current candidate-evidence path; they are not instructions for the report's current storage location.
