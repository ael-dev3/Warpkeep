...
test('general rehearsal proves populated v14 to v15 preservation and downgrade refusal', () => {
  ...
  assert.match(verifier, /The v15 boundary must refuse its immediate predecessor/);
