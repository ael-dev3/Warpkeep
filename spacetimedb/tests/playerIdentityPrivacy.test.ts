...
test('generated bindings contain the public projections and omit every private economy table', () => {
  ...
  const publicTableFiles = [
    ...
    'realm_chat_status_v_1_table.ts',
  ...
  const privateTableStems = [
    ...
    'realm_chat_channel_v_1',
    'realm_chat_message_v_1',
    'realm_chat_rate_event_v_1',
    'realm_chat_recent_v_1',
    'realm_chat_report_v_1',
    'realm_chat_report_rate_event_v_1',
    'realm_chat_send_receipt_v_1',
