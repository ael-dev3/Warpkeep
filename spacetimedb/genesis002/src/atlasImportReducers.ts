  ...
  ctx => ctx.withTx(tx => {
    try {
      ...
      return {
        ...
        state: atlas.state,
        importEpoch: atlas.importEpoch,
        verificationPhase: atlas.verificationPhase,
        verificationCursor: atlas.verificationCursor,
        verificationDigest: atlas.verificationDigest,
        expectedComponentCount: atlas.expectedComponentCount,
        expectedChunkCount: atlas.expectedChunkCount,
        expectedCellCount: atlas.expectedCellCount,
        expectedSlotCount: atlas.expectedSlotCount,
        expectedResourceNodeCount: atlas.expectedResourceNodeCount,
        ...
        regionManifestRows: atlas.regionManifestRows,
        componentRows: atlas.componentRows,
        chunkRows: atlas.chunkRows,
        cellRows: atlas.cellRows,
        slotRows: atlas.slotRows,
        resourceRows: atlas.resourceRows,
        claimRows: atlas.claimRows,
        occupancyRows: atlas.occupancyRows,
        activationRows: atlas.activationRows,
        publicAtlasRows: atlas.publicAtlasRows,
        publicRegionRows: atlas.publicRegionRows,
        workerSystemRows: atlas.workerSystemRows,
        importsExact: atlas.importsExact,
        ready: atlas.ready,
