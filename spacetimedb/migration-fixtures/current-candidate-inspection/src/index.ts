 ...
 * This inspection fixture exposes no reducer or procedure for the table.
 */
const productionPlayerCanaryBaselineV1 = table(
 ...
 * This inspection fixture exposes no reducer or procedure for the table.
 */
const productionPlayerCanaryApprovalRegistrationV1 = table(
...
const db = schema({
  ...
  // Current private canary suffix. Refs 0-83 above remain frozen verbatim.
  productionPlayerCanaryBaselineV1, productionPlayerCanaryApprovalRegistrationV1,
});
...
export const fixtureSeedGreaterRealmSentinelV17 = db.reducer(
  ...
  ctx => {
    ...
    ctx.db.greaterRealmReleaseV1.insert({
      ...
      releaseHeaderSha256: 'migration-release-header-sha',
      importEpoch: 1n,
      ...
      verifiedLegacyCellCount: 1,
      verifiedLegacyWaterCellCount: 1,
