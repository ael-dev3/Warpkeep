...
/** v15 public, identity-free Realm Chat readiness projection. */
...
/** v15 private channel authority and monotonic sequence cursor. */
...
/** v15 private permanent message archive. */
...
/** v15 bounded public recent-message projection. */
...
/** v15 private rolling rate ledger. */
...
/** v15 private exactly-once send receipts. */
...
/** v15 private one-reporter/one-message evidence. */
...
/** One typed row per v15 table for populated rollback and preservation proof. */
export const fixtureSeedRealmChatSentinelV15 = db.reducer(
  { name: 'fixture_seed_realm_chat_sentinel_v15' },
  ctx => {
    if (
    ...
    ctx.db.realmChatSendReceiptV1.insert({
      operationKey: '991301:018f7b44-5f2f-7c54-8c0d-3f521d46b194', fid: 991_301n,
      requestKey: '018f7b44-5f2f-7c54-8c0d-3f521d46b194', bodyDigest: '0000000000000000',
