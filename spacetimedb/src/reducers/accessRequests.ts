 ...
 * CAS transition. The module does not observe notification delivery or opens.
 * Missing identities use epoch and cycle zero; existing identities retain their
 * private auth epoch. Impossible future cycles fail closed.
 */
...
/**
 * Admin-only exact state for one request-CAS admission decision used by the
 * notification-gated Hermes operator. The module itself does not observe the
 * notification. The product contains no profile, note, token, or external
 * identity.
 */
