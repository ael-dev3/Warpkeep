...
import { genesisWaterRiverCellSet } from './waterWorld';
import {
 ...
 * transition.
 */
export const STONE_SITE_POLICY_VERSION = 'genesis-001-tier1-stone-sites-v3';
...
const GENESIS_TIER_I_STONE_EXPECTED_CANDIDATE_COUNT = 159;
...
const canonicalRiverCellKeys = genesisWaterRiverCellSet();
/**
...
const tierOneCandidates = Object.freeze(
  CANONICAL_WORLD_TILES.flatMap(tile => {
    ...
    if (
      ...
      || canonicalRiverCellKeys.has(tile.key)
