...
> 10,000-cell Genesis world and its 100 close-outward castle slots are seeded,
...
> generation-v3 candidate.** It preserves the exact 10,000-cell world and all
> 100 permanent castle slots, then adds a Gold Mine pilot, shared forest
> presentation, a Tier-I Wheat Farm Food pilot, and a
> Tier-I Logging Camp Wood pilot, versioned entry agreement, and atomic founder
> admission. It preserves the released protocol number, schema prefix,
> generation-v3 world, and live data. These additions are unavailable on
> Maincloud until the approved deletion-prohibited publication succeeds. See
> [Genesis 001 generation v3](./GENESIS_001_GENERATION_V3.md) for the world
> shape and compatibility boundary.
...
- Local and deployed world generation: `3`
