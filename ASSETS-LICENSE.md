...
of the Wheat Farm inspection presentation and instructed that it replace the
root README preview. That instruction authorizes the exact checked-in PNG for
...
| Intended use | Repository file | Technical record |
| --- | --- | --- |
| Root README development preview | `docs/reference/screenshots/2026-07-18-procedural-grass-wind-preview/warpkeep-procedural-grass-preview-eb156adea5befbd7.png` | 2000×1264 RGB PNG, 3,146,015 bytes, SHA-256 `f3b1f7e598c543d6c0e74813286da97d96b219ee56bc5d764c9853bfec27fe3e`. |
