...
describe('Warpkeep pointer perspective', () => {
  ...
  it('caps perspective travel so the title and complete galaxy remain readable', () => {
    ...
    expect(interaction.lightTravelX).toBeGreaterThanOrEqual(1.4);
    expect(interaction.lightTravelX).toBeLessThanOrEqual(2.8);
    expect(interaction.lightTravelY).toBeGreaterThanOrEqual(0.6);
    expect(interaction.lightTravelY).toBeLessThanOrEqual(1.5);
