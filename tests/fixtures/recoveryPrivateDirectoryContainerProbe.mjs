...
if (process.argv[2] === '--deny-uid') {
  ...
  assert.equal(path, '/home/warpkeep/.warpkeep-recovery-v1/pages-123-1');
  ...
  symlinkSync(path, '/home/warpkeep/.warpkeep-recovery-v1/pages-456-1');
  assert.throws(() => resolve('456', '1'), error);
  chmodSync(path, 0o755); assert.throws(() => resolve('123', '1'), error); chmodSync(path, 0o700);
  chmodSync('/home/warpkeep/.warpkeep-recovery-v1', 0o755);
  assert.throws(() => create('789', '1'), error);
  chmodSync('/home/warpkeep/.warpkeep-recovery-v1', 0o700);
  assert.equal(resolve('123', '1'), path);
