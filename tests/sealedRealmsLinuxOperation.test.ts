...
describe('fixed Linux operation input boundary',()=>{
 ...
 it.each(['preflight','g001-policy-observe','activation-evidence-inspect','activation-evidence-generate','ptr-update-inspect','ptr-update-apply','ptr-state-inspect','g002-update-inspect','g002-update-apply'])('routes supported operation %s into host attestation',async operation=>{
...
describe('fixed Linux operation executable boundary', () => {
 ...
 it.each(['preflight', 'g001-policy-observe', 'activation-evidence-inspect', 'activation-evidence-generate', 'ptr-update-inspect', 'ptr-update-apply', 'ptr-state-inspect', 'g002-update-inspect', 'g002-update-apply'])(
