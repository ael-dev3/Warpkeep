...
describe('Genesis canonical water artifact', () => {
  it('preserves the exact land boundary and ocean apron arithmetic', () => {
    ...
    expect(GENESIS_WATER_LAYOUT_DIGEST).toBe(
      'e9753e5eff5c73f05ef802aedf22575acf8ccbb634192827172f4d1455167f05'
    );
  ...
  it('freezes an acyclic priority-flood parent graph and river surface grades', () => {
    ...
    for (const river of GENESIS_RIVERS_V1) {
      ...
      expect(rows.at(-1)!.surfaceLevelMilli).toBeGreaterThanOrEqual(GENESIS_WATER_SEA_LEVEL_MILLI);
