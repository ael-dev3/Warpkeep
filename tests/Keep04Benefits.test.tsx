...
it('shows exact six building costs, deficits, duration and completed-only current/next effects', () => {
  ...
  const cases = [
    ['City Mill', 'food 20 · wood 40 · stone 20 · gold 0', 'Food per 10-second quantum', 'Current: 10 → Next: 12'],
    ['Lumber Camp', 'food 20 · wood 20 · stone 40 · gold 0', 'Wood per 10-second quantum', 'Current: 10 → Next: 12'],
    ['City Stoneworks', 'food 40 · wood 20 · stone 20 · gold 0', 'Stone per 10-second quantum', 'Current: 10 → Next: 12'],
    ['City Goldworks', 'food 40 · wood 60 · stone 40 · gold 20', 'Gold per 10-second quantum', 'Current: 10 → Next: 12'],
  ...
  expect(screen.getByText(/existing expeditions keep their captured rates/i)).toBeVisible();
