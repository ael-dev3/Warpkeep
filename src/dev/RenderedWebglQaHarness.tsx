...
function rendererFromRoot(root: HTMLElement | null): RenderedWebglQaRenderer {
  const renderer = root?.querySelector<HTMLElement>('.realm-map-screen')?.dataset.renderer;
