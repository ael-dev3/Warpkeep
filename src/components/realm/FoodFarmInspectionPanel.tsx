...
function nodeNotice(
  ...
  if (publicOccupant) {
    return publicOccupant.occupiedByViewer
      ? 'Your gathering assignment is recorded by the Realm. Food settlement remains server-authoritative.'
      : 'This Farm is occupied. The gathering keeper is public, while their resources and commands remain private.';
  }
